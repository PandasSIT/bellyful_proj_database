...
(
	...
	[branch_id] Int NULL,
	[role_id] int NULL,
	[IsAssignedUserAccount] bit Null,
...
VALUES
	('Aries', 'Gibbon', '19880822', 'asd@asd.com', '0212912123', null, '111 Tay St ', 'Invercargill', null, 2, 3, 1,0);
INSERT INTO [volunteer]
VALUES
	('Sandy', 'Foster', '19880822', 'asd@asd.com', '0212912123', null, '122 Tay St ', 'Invercargill', null, 2, 3, 1,0);
INSERT INTO [volunteer]
VALUES
	('Giles', 'James', '19880822', 'asd@asd.com', '0212912123', null, '131 Tay St ', 'Invercargill', null, 2, 3, 1,0);
INSERT INTO [volunteer]
VALUES
	('Clare ', 'Hoover', '19880822', 'asd@asd.com', '0212912123', null, '14 Tay St ', 'Invercargill', null, null, 3, 1,0);
INSERT INTO [volunteer]
VALUES
	('Natalie', 'Dupont', '19910822', 'asd@asd.com', '0212912123', null, '151 Tay St ', 'Invercargill', null, null, 3, 2,0);
INSERT INTO [volunteer]
VALUES
	('Julian', 'Wheatley', '19950822', 'asd@asd.com', '0212912123', null, '151 Tay St ', 'Invercargill', null, null, 3, 2,0);
INSERT INTO [volunteer]
VALUES
	('Quentin', 'Jasper', '19980822', 'asd@asd.com', '0212912123', null, '151 Tay St ', 'Invercargill', null, null, 3, 3,0);
INSERT INTO [volunteer]
VALUES
	('Dominic', 'Dolly', '19980822', 'asd@asd.com', '0212912123', null, '151 Tay St ', 'Invercargill', null, null, 3, 2,0);
INSERT INTO [volunteer]
VALUES
	('Evan', 'Reed', '19980822', 'asd@asd.com', '0212912123', null, '151 Tay St ', 'Invercargill', null, null, 3, 3,0);
...
-- Trigger 限定 最低库存
go
DROP trigger IF EXISTS [Instock_Constrains_for_createOrder]
go
CREATE TRIGGER [Instock_Constrains_for_createOrder] 
ON [order]
INSTEAD OF INSERT 
AS
Begin
-- 如果 type 1 的库存量 小于  该订单受助者家庭的成年人数量  （低于3份 就无法创建订单  报错 ）
...
or  (Select [instock_amount] from  [meal_instock]where [meal_type_id] = 4 ) < (0 +  (select adults_num from recipient where recipient_id = (select recipient_id from Inserted)))
begin
	RAISERROR (15600,-1,-1, 'Type 1 Meal of Instock !!');
end
else begin
INSERT INTO [order]([recipient_id]) SELECT  [recipient_id] from inserted
end
END
go
...
go
DROP PROCEDURE IF EXISTS sp_CancelAnOrder
go
CREATE PROCEDURE sp_CancelAnOrder
	@orderId int
AS
BEGIN
	if(
	(select [status_id]
		...
		update [meal_instock]
			set [instock_amount] += (select adults_num from recipient where recipient_id = (select recipient_id from [Order] where order_id =   @orderId))
						where [meal_type_id] = 4; -- select * from [order]  TRUNCATE TABLE  [order] 
					
	end
	else 
		begin
		RAISERROR (15600,-1,-1, 'Only can cancel order that status is Created or Pushed');
	end
END
go
...
INSERT INTO [order]([recipient_id])VALUES( 2);

INSERT INTO [order]([recipient_id])VALUES(3);

INSERT INTO [order]([recipient_id])VALUES( 4);
INSERT INTO [order]([recipient_id])VALUES( 5);
INSERT INTO [order]([recipient_id])VALUES( 6);
INSERT INTO [order]([recipient_id])VALUES( 1);
INSERT INTO [order]([recipient_id])VALUES( 3);
INSERT INTO [order]([recipient_id])VALUES( 4);

EXEC sp_CancelAnOrder 1
EXEC sp_CancelAnOrder 2
...
VALUES
	('1', 'L1_Admin', 'L1_Admin' ,null);

	INSERT INTO [AspNetRoles]
VALUES
	('2', 'L2_Manager', 'L2_Manager' ,null);

	INSERT INTO [AspNetRoles]
VALUES
	('3', 'L3_ChefManager', 'L3_ChefManager' ,null);

	INSERT INTO [AspNetRoles]
VALUES
	('4', 'L4_DeliverMan', 'L4_DeliverMan' ,null);

	INSERT INTO [AspNetRoles]
VALUES
	('5', 'L5_GeneralStaff', 'L5_GeneralStaff' ,null);
