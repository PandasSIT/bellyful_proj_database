...
go
DROP PROCEDURE IF EXISTS sp_ClearAllTables
go
...
BEGIN
	...
	--grey
	TRUNCATE table [volunteer_police_info]
	TRUNCATE table [volunteer_training_info]
	TRUNCATE table [volunteer_emergency_contact]
	TRUNCATE table [volunteer]
	TRUNCATE table [volunteer_role]
	TRUNCATE table [volunteer_status]
	--green
	--blue
	TRUNCATE table [recipient]
	TRUNCATE table [referrer]
	TRUNCATE Table [referral_reason]
	TRUNCATE table [dietary_requirement]
	TRUNCATE table [referrer_role]
